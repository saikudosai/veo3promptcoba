...
<body class="text-gray-200">
    ...
    <header class="bg-gray-900/50 border-b border-gray-700/50 backdrop-blur-sm sticky top-0 z-20">
        <div class="container mx-auto max-w-5xl flex items-center justify-between p-4 relative">
             ...
             <div class="flex items-center space-x-4">
                 <!-- [MODIFIED] Menampilkan nama pengguna dan tombol logout -->
                 <span class="text-white font-semibold">
                     Halo, <?php echo htmlspecialchars($_SESSION['username']); ?>
                 </span>
                 <a href="logout.php" title="Logout" class="bg-red-600 hover:bg-red-700 text-white font-bold h-8 w-8 rounded-full text-lg transition-colors flex items-center justify-center shadow-lg">
    ...
    <main class="container mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
        <!-- Sisa konten HTML Anda tetap sama persis -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-5 bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-300">Deskripsikan dari Gambar</label>
